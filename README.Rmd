...
```{r latent-shapes, fig.height=4, fig.width=8, message=FALSE, eval=requireNamespace("ggplot2", quietly = TRUE), fig.alt="Faceted density comparison of normal, bimodal, positively skewed, and heavy-tailed latent ability distributions."}
compare_shapes(
  n = 3000,
