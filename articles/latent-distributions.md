...
different shapes while maintaining rigorous standardization properties.
...
2.  Available distribution shapes (12 supported shapes including
    `custom`)
...
[`sim_latentG()`](https://joonho112.github.io/IRTsimrel/reference/sim_latentG.md)
provides 12 supported shapes, including 11 built-in pre-standardized
shapes plus the `custom` mixture option.
...
![Histogram and density plot of a standard normal latent ability
distribution with a normal reference
curve.](latent-distributions_files/figure-html/normal-1.png)
...
with two symmetric
modes.](latent-distributions_files/figure-html/bimodal-1.png)
...
![Histogram and density plot of a bimodal latent distribution with wider
mode
separation.](latent-distributions_files/figure-html/bimodal-delta-1.png)
...
![Histogram and density plot of a trimodal latent ability distribution
with one central and two side
modes.](latent-distributions_files/figure-html/trimodal-1.png)
...
![Histogram and density plot of a trimodal latent distribution with a
stronger central
peak.](latent-distributions_files/figure-html/trimodal-custom-1.png)
...
![Histogram and density plot of a four-component multimodal latent
ability
distribution.](latent-distributions_files/figure-html/multimodal-1.png)
...
![Histogram and density plot of a positively skewed latent ability
distribution.](latent-distributions_files/figure-html/skew-pos-1.png)
...
![Histogram and density plot of a negatively skewed latent ability
distribution.](latent-distributions_files/figure-html/skew-neg-1.png)
...
![Histogram and density plot of a heavy-tailed latent ability
distribution with a normal reference
curve.](latent-distributions_files/figure-html/heavy-tail-1.png)
...
![Histogram and density plot of a light-tailed latent ability
distribution.](latent-distributions_files/figure-html/light-tail-1.png)
...
![Histogram and density plot of a uniform latent ability
distribution.](latent-distributions_files/figure-html/uniform-1.png)
...
![Histogram and density plot of a latent ability distribution with a
floor effect.](latent-distributions_files/figure-html/floor-1.png)
...
![Histogram and density plot of a latent ability distribution with a
ceiling effect.](latent-distributions_files/figure-html/ceiling-1.png)
...
![Faceted density comparison across all built-in latent distribution
shapes.](latent-distributions_files/figure-html/compare-shapes-1.png)
...
![Histogram and density plot of a custom three-component latent mixture
distribution.](latent-distributions_files/figure-html/custom-mixture-1.png)
...
for (sh in shapes_feas) {
  feas <- check_feasibility(
    ...
    item_source = "parametric", target_rho = 0.80,
...
|:-------|:-----------|--------------:|--------------:|------------:|------------:|
| lower  | normal     |        0.0591 |        0.9872 |      0.0002 |      0.9146 |
| lower1 | bimodal    |        0.0583 |        0.9834 |      0.0583 |      0.9722 |
| lower2 | skew_pos   |        0.0589 |        0.9864 |      0.0000 |      0.8804 |
| lower3 | heavy_tail |        0.0581 |        0.9857 |      0.0000 |      0.8706 |
| lower4 | uniform    |        0.0595 |        0.9856 |      0.0595 |      0.9576 |
...
![Reliability curves comparing how latent distribution shape changes the
reliability-scale
relationship.](latent-distributions_files/figure-html/shape-curves-1.png)

The figure shows that all shapes can reach high reliability, but some
require larger scaling factors $`c`$ to compensate for the reduced
average information when ability mass is spread away from the item
difficulty region.
