...
- [Working with Latent
  ...
  sim_latentG(), covering 12 supported shapes including custom mixtures,
...
- [Generating Realistic Item
  ...
  sim_item_params(), covering parametric defaults, optional IRW
  integration, hierarchical and custom sources, the copula method for
  correlated parameters, and extracting calibrated items with coef().
