...
Registered S3 methods with standalone reference topics
...
- [`as.numeric(`*`<latent_G>`*`)`](https://joonho112.github.io/IRTsimrel/reference/as.numeric.latent_G.md)
  [`as.double(`*`<latent_G>`*`)`](https://joonho112.github.io/IRTsimrel/reference/as.numeric.latent_G.md)
...
Backward-compatible aliases retained for migration from v0.1.x naming
