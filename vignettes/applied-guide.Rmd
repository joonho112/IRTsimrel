...
EQC (Empirical Quadrature Calibration) is Algorithm 1 from Lee (2026).  It uses
...
4. **Always warm-start SAC** from EQC for faster convergence when comparing to
   an EQC result.
...
- Well behaved over practical EQC search intervals; for very wide finite
  empirical quadrature bounds, the implementation checks an interior maximum
