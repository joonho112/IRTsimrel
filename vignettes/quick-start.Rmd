...
The `target_status_info` and `target_status_msem` fields summarize this
metric-specific screening result.
...
- **`vignette("applied-guide")`**: Comprehensive applied tutorial covering
  2PL models, non-normal latent distributions, optional IRW-based item sources,
  and factorial simulation designs with multiple reliability levels.
