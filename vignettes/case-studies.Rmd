...
> bias and RMSE. The maximum calibration error across conditions
> was less than 0.001.
...
```{r cs2-plot, fig.height = 6, fig.cap = "Impact of latent distribution misspecification. Top: actual reliability shifts away from the 0.80 target under non-normal generation. Bottom: difficulty RMSE varies with generating shape, driven partly by the reliability shift.", fig.alt = "Two-panel bar plot showing actual reliability and difficulty RMSE by generating latent shape."}
